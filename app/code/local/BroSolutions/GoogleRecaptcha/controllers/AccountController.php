...
class BroSolutions_GoogleRecaptcha_AccountController extends Mage_Customer_AccountController
{
    ...
    public function createPostAction()
    {
        ...
        $recaptchaValid = $this->_checkRecaptcha($post);
        if(!$recaptchaValid){
            Mage::getSingleton('customer/session')->addError(Mage::helper('contacts')->__('Invalid reCAPTCHA.'));
            $this->_redirect('*/*/*/');
            return;
        }
