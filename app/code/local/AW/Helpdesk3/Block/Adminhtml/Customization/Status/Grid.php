...
class AW_Helpdesk3_Block_Adminhtml_Customization_Status_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('awhdu3CustomizationStatusGrid');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            array(
                ...
                'renderer'  => 'aw_hdu3/adminhtml_widget_grid_renderer_statusActions',
                'filter'    => false,
                'sortable'  => false,
                'is_system' => true,
            )
