...
class AW_Helpdesk3_Block_Adminhtml_Widget_Grid_Renderer_PriorityActions
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Action
{
    public function render(Varien_Object $row)
    {
        ...
        if ($id = $row->getData('id')) {
            /**
             * @var $department AW_Helpdesk3_Model_Ticket_Priority
             */
            $department = Mage::getModel('aw_hdu3/ticket_priority')->load($id);
