...
class AW_Helpdesk3_Block_Adminhtml_Ticket_Edit_Form_Thread extends Mage_Adminhtml_Block_Template
{
    ...
    {
        return $this->getUrl('adminhtml/awhdu3_ticket/ajaxAddNote', array('id' => $this->getTicket()->getId()));
    }
    ...
    {
        return $this->getUrl(
            'adminhtml/awhdu3_ticket/ajaxGetThreadTabsContentHtml', array('id' => $this->getTicket()->getId())
        );
    }
