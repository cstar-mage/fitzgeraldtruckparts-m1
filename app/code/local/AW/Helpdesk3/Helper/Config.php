...
class AW_Helpdesk3_Helper_Config extends Mage_Core_Helper_Abstract
{
    ...
    const FRONTEND_STANDARD_CONTACT_FORM_DISABLE_EMAIL = 'aw_helpdesk3/frontend/standard_contact_form_disable_email';
    ...
    * @return bool
    */
    public static function isDisableStandardContactFormEmailEnabled($store = null)
    {
        return (bool)Mage::getStoreConfig(self::FRONTEND_STANDARD_CONTACT_FORM_DISABLE_EMAIL, $store);
    }
    ...
    */
     ...
     * @return bool
     */
    public function isCanShowSkuSelectorOnTicketCreate($store = null) {
        
        $selectors = Mage::getStoreConfig(self::FRONTEND_SHOW_SELECTORS, $store);
        if (!empty($selectors)) {
            $selectors = explode(',', $selectors);
        }
        return in_array(AW_Helpdesk3_Model_Source_Ticket_Frontend_Selectors::SKU_VALUE, (array)$selectors);
    }
