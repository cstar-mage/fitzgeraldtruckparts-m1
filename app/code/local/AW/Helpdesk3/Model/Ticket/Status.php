...
/**
 * Class AW_Helpdesk3_Model_Ticket_Status
 * @method string getId()
 ...
 */
class AW_Helpdesk3_Model_Ticket_Status extends Mage_Core_Model_Abstract
{
    ...
    {
        return $this->getResource()->getStatusTitle($this, $storeId);
    }
     ...
     *
     * @return AW_Helpdesk3_Model_Resource_Ticket_Status
     */
