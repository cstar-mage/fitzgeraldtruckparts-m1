...
{
    protected $_additionalFields = array('telephone', 'street_1', 'street_2', 'region_id', 'postcode', 'country_id', 'comment');
    ...
    public function predispatchContactsIndexPost()
    {
        ...
        try {
            ...
            if(Mage::helper('aw_hdu3/config')->isDisableStandardContactFormEmailEnabled()){
                Mage::getSingleton('customer/session')->addSuccess(Mage::helper('contacts')->__('Your inquiry was submitted and will be responded to as soon as possible. Thank you for contacting us.'));
                $response = Mage::app()->getResponse();
                $response->setRedirect(Mage::getUrl('*/*/'))->sendResponse();
                $this->stopFurtherDispatching();
            }
        } catch (Exception $e) {
    ...
    private function stopFurtherDispatching()
    {
    ...
    public function createFromOrder()
    {
        if (Mage::app()->getRequest()->getParam('create_ticket')) {
            ...
            $ticketUrl = Mage::helper('adminhtml')->getUrl('adminhtml/awhdu3_ticket/edit', array('id'  => $ticket->getId()));
