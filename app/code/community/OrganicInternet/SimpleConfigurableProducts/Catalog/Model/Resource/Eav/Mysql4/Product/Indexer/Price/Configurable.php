    ...
    protected function _prepareFinalPriceData($entityIds = null)
    {
        ...
        $select = $write->select()
            ...
            ->join(
                ...
                array())
            ->joinLeft(
                array('pgp' => $this->_getGroupPriceIndexTable()),
                'ce.entity_id = pgp.entity_id',
                array())
            ->join(
        ...
        $select->columns(array(
            ...
            'group_price'       => new Zend_Db_Expr('pgp.price'),
            'base_group_price'  => new Zend_Db_Expr('pgp.price'),
        ));
        ...
        $outerSelect = $write->select()
            ...
            ->group(array('inner.entity_id', 'inner.customer_group_id', 'inner.website_id', 'group_price', 'base_group_price'));
