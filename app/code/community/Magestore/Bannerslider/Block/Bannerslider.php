...
class Magestore_BannerSlider_Block_BannerSlider extends Mage_Core_Block_Template
{
	...
	public function getBannerCollection() {
		...
		if ($currentCategory && $this->_display == Magestore_Bannerslider_Helper_Data::DISP_CATEGORY){
			$currentCategoryId = Mage::registry('current_category')->getId();
			$collection->addFieldToFilter('categories',array('finset' => $currentCategoryId));
		}
